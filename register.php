 ...
 <body>
        <nav class="navbar shadow-sm slide-in-left">
         ...
         <div class="container mt-4 puff-in-center">
             <div class="row">
                 <div class="col-12">
                     <h1 class="text-center text-white">Register New Student Records Assistant</h1>
                 </div>
            </div>
            <?php
                vald();
   ...
   <div class="container text-center">
       <div class="row">
           <div class="col col-sm-5 text-left">
               <small>Copyright &copy;Centro Muscular University     Office of the Registrar 2023</small>
           </div>
           <div class="col text-right">
               <small>Created by: Lyzza Abig, Alcedrick Garcia, Joanna Policarpio, Leonard Bruno, Jannah Pescadera</small>
           </div>
       </div>
   </div>
 </footer>
